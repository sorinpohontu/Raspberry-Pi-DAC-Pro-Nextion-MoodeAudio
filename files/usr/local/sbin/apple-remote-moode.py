...
Buttons = [0x377e1d055, 0x377e1b055, 0x377e11055, 0x377e1e055, 0x377e1ba55, 0x377e14055, 0x377e17a55]  # HEX code list
ButtonsNames = ["UP", "DOWN", "LEFT", "RIGHT", "OK", "MENU", "PLAY"]      # String list in same order as HEX list
...
def getBinary():
	...
	while value:
		time.sleep(0.001) # This sleep decreases CPU utilization immensely
...
while True:
	...
	for button in range(len(Buttons)):#Runs through every value in list
		if hex(Buttons[button]) == inData: #Checks this against incoming
			...
			if ButtonsNames[button] == "PLAY":
				subprocess.call(["mpc", "toggle"])
			elif ButtonsNames[button] == "OK":
				subprocess.call(["/var/www/vol.sh", "mute"])
				print ("volume MUTE")
